...
public class Slide {
	...
	//Create a main.slide.TextItem out of a String and add the main.slide.TextItem
	public void append(int level, String message) {
		append(new TextItem(level, message));
	}

	//Returns the main.slide.SlideItem
